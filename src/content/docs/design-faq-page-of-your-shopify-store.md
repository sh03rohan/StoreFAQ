---
title: "How to Design FAQ Page of Your Shopify Store using StoreFAQ?"
slug: "design-faq-page-of-your-shopify-store"
category: "configuration"
categoryName: "Configurations"
order: 0
published: "2024-07-27T11:14:50"
updated: "2026-06-22T09:56:43"
excerpt: "Learn how to design FAQ page of your Shopify store using StoreFAQ Shopify app from this quick and easy documentation."
---

<p><a href="/"><strong>StoreFAQ</strong></a> is a Shopify FAQ builder solution with which you can help reduce your support tickets and boost your sales by providing instant customer support. Learn how to design FAQ page of your Shopify store using StoreFAQ from this step-by-step documentation.</p>

<h2><strong>How to Design FAQ Page Of Your Shopify Store using StoreFAQ?</strong></h2>

<p>First, you have to <strong><a href="/docs/how-to-install-storefaq/" data-type="link">install StoreFAQ Shopify app</a></strong>. So, find and install the app from the ‘<strong>Apps</strong>’ option in your Shopify admin dashboard. Then, follow these steps:</p>

<h3><strong>Step 1: Navigate to the ‘Design’ Tab On StoreFAQ</strong></h3>
...
<p>First, we have the option to design the <strong>Header </strong>and <strong>Sub Header </strong>sections. Just click on the corresponding button on the left to start designing. You can customize the content, title tag (for the Header only), font size, font color and margin (top, right, bottom and left).</p>
...
<p>There are some extra options that can help you during the design process. You can preview everything from the buttons in the top right corner. </p>
